...
import { ReactComponent as LoaderIcon } from '../../assets/Subtract.svg';
...
const Loader: React.FC<LoaderProps> = ({ size, className }, ...props) => {
    const loaderWidth = size === 'l' ? '60' : size === 'm' ? '48' : size === 's' ? '24' : '60';
    return (
        <svg className={className} viewBox="0 0 60 60" width={loaderWidth} height={loaderWidth} fill="none" xmlns="http://www.w3.org/2000/svg">
